...
(defvar lupan-themes-color-hue
  '((red . 0.0) (orange . 0.10784313725490197) (yellow . 0.16666666666666666)
    (green . 0.3333333333333333) (spring-green . 0.41633986928104577) (cyan . 0.5) (blue . 0.6666666666666666)
    (slate-blue . 0.6901234567901234) (indigo . 0.7628205128205128) (magenta . 0.8333333333333334)))
  ...
  (cl-flet ((c (dark light)
    ...
    (let* ((red-0-9 (c "#ffebee" "#b71c1c"))
      ...
      (custom-theme-set-faces
       ...
       `(header-line ((t (:background ,blue-grey-7-1, :foreground ,purple-2-6))))
       `(org-level-1 ((t (:height 1.3 :foreground ,purple-2-6))))
       `(org-level-2 ((t (:height 1.2 :foreground ,purple-2-6))))
       `(org-level-3 ((t (:height 1.1 :foreground ,purple-2-6))))
       ...
       `(lsp-ui-doc-background ((t (:background ,blue-grey-7-1))))
...
(defun lupan-themes-create-dark-theme (theme bg saturation luminance)
  (let ((black "#000000")
    ...
    (cl-flet ((c (color &optional (variant 'base)) (funcall get-color color variant)))
	...
	(custom-theme-set-faces
	 ...
	 `(font-lock-string-face ((t (:foreground ,(c 'slate-blue)))))
	 ...
	 `(header-line ((t (:background ,dark3-gray :foreground ,(c 'magenta)))))
	 `(org-level-1 ((t (:height 1.3 :foreground ,(c 'magenta)))))
	 `(org-level-2 ((t (:height 1.2 :foreground ,(c 'magenta)))))
	 `(org-level-3 ((t (:height 1.1 :foreground ,(c 'magenta)))))
	 ...
	 `(lazy-highlight ((t (:background ,(c 'slate-blue) :foreground ,(c 'slate-blue 'dark3)))))
	 ...
	 `(helm-swoop-target-word-face ((t (:background ,(c 'slate-blue 'dark1) :foreground ,fg))))
	 ...
	 `(helm-ff-socket ((t (:foreground ,(c 'slate-blue)))))
	 ...
	 `(helm-ls-git-conflict-face ((t (:foreground ,(c 'slate-blue)))))
	 ...
	 `(helm-rg-directory-header-face ((t (:foreground ,(c 'slate-blue)))))
	 ...
	 `(helm-rg-title-face ((t (:foreground ,(c 'slate-blue)))))
	 ...
	 `(dired-subtree-depth-2-face ((t (:background ,(c 'slate-blue 'dark3-grayish)))))
	 `(dired-subtree-depth-3-face ((t (:background ,bg))))
	 `(dired-subtree-depth-4-face ((t (:background ,dark3-gray))))
	 `(dired-subtree-depth-5-face ((t (:background ,(c 'slate-blue 'dark3-grayish)))))
	 ...
	 `(magit-cherry-equivalent ((t (:foreground ,(c 'slate-blue)))))
	 `(magit-reflog-amend ((t (:foreground ,(c 'slate-blue)))))
	 ...
	 `(magit-reflog-rebase ((t (:foreground ,(c 'slate-blue)))))
	 ...
	 `(lsp-ui-doc-background ((t (:background ,dark3-gray))))
...
(defun lupan-themes-create-light-theme (theme bg saturation luminance)
  (let ((black "#000000")
	(get-color
	 (lupan-themes-get-color-function
	  (cons (list 'selected 'hsl (car (apply #'color-rgb-to-hsl (color-name-to-rgb bg))) saturation luminance)
		(mapcar (lambda (c) (list (car c) 'hsl (cdr c) saturation luminance)) lupan-themes-color-hue))
	  '((base 0 0) (light 0 30) (very-light 0 40) (dark 0 -40) (light-grayish -15 30) (grayish -15 0)
	    (dark3-grayish -15 -40) (l-very-light 0 90) (l-light 0 80) (l-base 0 50) (l-dark3 0 30)))))
    (cl-flet ((c (color &optional (variant 'base)) (funcall get-color color variant)))
      (let ((fg (c 'selected 'dark3-grayish))
	    (very-light-gray (c black 'l-very-light))
	    (light-gray (c black 'l-light))
	    (gray (c black 'l-base)))
	(custom-theme-set-faces
	 theme
	 ...
	 `(font-lock-builtin-face ((t (:foreground ,(c 'magenta)))))
	 `(link ((t (:foreground ,(c 'blue) :underline t))))
	 `(link-visited ((t (:foreground ,(c 'indigo) :underline t))))
	 `(font-lock-string-face ((t (:foreground ,(c 'slate-blue)))))
	 `(font-lock-constant-face ((t (:foreground ,(c 'orange)))))
	 `(font-lock-variable-name-face ((t (:foreground ,(c 'green)))))
	 `(font-lock-type-face ((t (:foreground ,(c 'yellow)))))
	 `(custom-state ((t (:foreground ,(c 'green)))))
	 `(font-lock-comment-face ((t (:foreground ,(c 'cyan 'grayish)))))
	 `(mode-line ((t (:background ,(c 'selected 'light) :foreground ,(c 'selected 'dark) :box (:line-width -1 :style released-button)))))
	 `(mode-line-inactive ((t (:background ,(c 'selected 'light-grayish) :foreground ,(c 'gray 'dark) :box (:line-width -1 :style released-button) :inherit (mode-line)))))
	 `(minibuffer-prompt ((t (:foreground ,(c 'selected)))))
	 `(region ((t (:background ,(c 'selected 'light) :foreground ,(c 'selected 'dark) :extend t))))
	 `(shadow ((t (:foreground ,(c 'selected 'light-grayish)))))
	 `(highlight ((t (:background ,(c 'selected 'light) :foreground ,(c 'selected 'dark)))))
	 `(show-paren-match ((t (:background ,(c 'magenta) :foreground ,bg))))
	 `(gnus-group-mail-3 ((t (:foreground ,(c 'green) :weight bold))))
	 `(gnus-group-mail-3-empty ((t (:foreground ,(c 'green)))))
	 `(gnus-summary-normal-ancient ((t (:foreground ,(c 'cyan)))))
	 `(gnus-summary-normal-read ((t (:foreground ,(c 'green)))))
	 ...
	 `(term-color-white ((t (:background ,fg :foreground ,fg))))
	 `(term-color-yellow ((t (:background ,(c 'yellow) :foreground ,(c 'yellow)))))
	 `(header-line ((t (:background ,very-light-gray :foreground ,(c 'magenta)))))
	 `(org-level-1 ((t (:height 1.3 :foreground ,(c 'magenta)))))
	 `(org-level-2 ((t (:height 1.2 :foreground ,(c 'magenta)))))
	 `(org-level-3 ((t (:height 1.1 :foreground ,(c 'magenta)))))
	 `(org-ellipsis ((t (:foreground ,(c 'blue)))))
	 ...
	 `(ido-only-match ((t (:foreground ,(c 'green)))))
	 `(ido-subdir ((t (:foreground ,(c 'blue) :weight bold))))
	 `(lazy-highlight ((t (:background ,(c 'magenta 'light) :foreground ,(c 'magenta)))))
	 `(helm-selection ((t (:background ,(c 'selected 'light)))))
	 `(helm-match ((t (:foreground ,(c 'yellow)))))
	 `(helm-separator ((t (:foreground ,(c 'red)))))
	 `(helm-candidate-number ((t (:background ,(c 'selected 'very-light) :foreground ,(c 'selected 'dark)))))
	 `(helm-source-header ((t (:weight bold :height 1.3 :family "Sans Serif"))))
	 `(helm-swoop-target-line-face ((t (:background ,(c 'yellow 'light) :foreground ,fg))))
	 `(helm-swoop-target-line-block-face ((t (:background ,(c 'yellow 'light) :foreground ,fg))))
	 `(helm-swoop-target-word-face ((t (:background ,(c 'magenta 'light) :foreground ,(c 'magenta)))))
	 `(helm-M-x-key ((t (:foreground ,(c 'orange)))))
	 `(helm-buffer-not-saved ((t (:foreground ,(c 'red) :weight bold))))
	 `(helm-buffer-size ((t (:foreground ,(c 'yellow)))))
	 `(helm-buffer-directory ((t (:foreground ,(c 'blue) :weight bold))))
	 ...
	 `(helm-ff-executable ((t (:foreground ,(c 'green)))))
	 `(helm-ff-invalid-symlink ((t (:background ,(c 'red 'light) :foreground ,(c 'red)))))
	 `(helm-ff-pipe ((t (:background ,black :foreground ,(c 'yellow)))))
	 `(helm-ff-socket ((t (:foreground ,(c 'slate-blue)))))
	 `(helm-ff-suid ((t (:background ,(c 'red 'light) :foreground ,fg))))
	 `(helm-git-grep-match ((t (:foreground ,(c 'red)))))
	 `(helm-ls-git-added-copied-face ((t (:foreground ,(c 'green)))))
	 `(helm-ls-git-added-modified-face ((t (:foreground ,(c 'blue)))))
	 `(helm-ls-git-conflict-face ((t (:foreground ,(c 'slate-blue)))))
	 `(helm-ls-git-deleted-and-staged-face ((t (:foreground ,(c 'blue 'grayish)))))
	 `(helm-ls-git-deleted-not-staged-face ((t (:foreground ,(c 'red)))))
	 `(helm-ls-git-modified-and-staged-face ((t (:foreground ,(c 'orange)))))
	 `(helm-ls-git-modified-not-staged-face ((t (:foreground ,(c 'orange)))))
	 `(helm-ls-git-renamed-modified-face ((t (:foreground ,(c 'orange)))))
	 `(helm-ls-git-untracked-face ((t (:foreground ,(c 'red)))))
	 `(helm-grep-file ((t (:foreground ,(c 'green) :weight bold))))
	 `(helm-grep-lineno ((t (:foreground ,(c 'orange)))))
	 `(helm-rg-directory-header-face ((t (:foreground ,(c 'magenta)))))
	 `(helm-rg-error-message ((t (:foreground ,(c 'red)))))
	 `(helm-rg-file-match-face ((t (:foreground ,(c 'green) :weight bold))))
	 `(helm-rg-line-number-match-face ((t (:foreground ,(c 'orange)))))
	 `(helm-rg-active-arg-face ((t (:foreground ,(c 'cyan)))))
	 `(helm-rg-base-rg-cmd-face ((t (:foreground ,(c 'blue)))))
	 `(helm-rg-inactive-arg-face ((t (:foreground ,(c 'blue 'grayish)))))
	 `(helm-rg-title-face ((t (:foreground ,(c 'slate-blue)))))
	 `(helm-lisp-show-completion ((t (:background ,(c 'light-gray)))))
	 `(helm-match ((t (:foreground ,(c 'yellow)))))
	 `(ivy-current-match ((t (:background ,(c 'selected 'light) :foreground ,fg))))
	 `(ivy-highlight-face ((t (:foreground ,(c 'orange) :weight bold))))
	 `(match ((t (:background ,(c 'yellow 'light) :foreground ,(c 'yellow 'dark)))))
	 `(ivy-match-required-face ((t (:foreground ,(c 'red)))))
	 `(ivy-minibuffer-match-highlight ((t (:background ,light-gray :foreground ,bg))))
	 `(ivy-minibuffer-match-face-1 ((t (:background ,(c 'cyan 'light) :foreground ,(c 'cyan 'dark)))))
	 `(ivy-minibuffer-match-face-2 ((t (:background ,(c 'yellow 'light) :foreground ,(c 'yellow 'dark)))))
	 `(ivy-minibuffer-match-face-3 ((t (:background ,(c 'magenta 'light) :foreground ,(c 'magenta 'dark)))))
	 `(ivy-minibuffer-match-face-4 ((t (:background ,(c 'red 'light) :foreground ,(c 'red 'dark)))))
	 `(ivy-modified-buffer ((t (:foreground ,(c 'orange)))))
	 `(ivy-modified-outside-buffer ((t (:foreground ,(c 'orange)))))
	 `(ivy-remote ((t (:foreground ,(c 'red)))))
	 `(dired-directory ((t (:foreground ,(c 'blue) :weight bold))))
	 ...
	 `(dired-subtree-depth-2-face ((t (:background ,(c 'yellow 'light)))))
	 `(dired-subtree-depth-3-face ((t (:background ,bg))))
	 `(dired-subtree-depth-4-face ((t (:background ,light-gray))))
	 `(dired-subtree-depth-5-face ((t (:background ,(c 'yellow 'light)))))
	 `(dired-subtree-depth-6-face ((t (:background ,bg))))
	 `(diff-added ((t (:background ,(c 'green 'light) :foreground ,(c 'green) :extend t))))
	 `(diff-indicator-added ((t (:foreground ,(c 'green) :inherit (diff-added)))))
	 `(diff-refine-added ((t (:background ,(c 'green 'grayish) :foreground ,(c 'green 'light)))))
	 `(diff-removed ((t (:background ,(c 'red 'light) :foreground ,(c 'red) :extend t))))
	 `(diff-indicator-removed ((t (:foreground ,(c 'red) :inherit (diff-removed)))))
	 `(diff-refine-removed ((t (:background ,(c 'red 'grayish) :foreground ,(c 'red 'light)))))
	 `(smerge-base ((t (:background ,(c 'selected 'light)))))
	 `(smerge-lower ((t (:background ,(c 'green 'light) :foreground ,(c 'green)))))
	 `(smerge-markers ((t (:background ,light-gray))))
	 `(smerge-refined-added ((t (:background ,(c 'green 'grayish) :foreground ,(c 'green 'light)))))
	 `(smerge-refined-removed ((t (:background ,(c 'red 'grayish) :foreground ,(c 'red 'light)))))
	 `(smerge-upper ((t (:background ,(c 'red 'light) :foreground ,(c 'red)))))
	 `(magit-section-heading ((t (:foreground ,(c 'orange)))))
	 `(magit-section-highlight ((t (:background ,(c 'selected 'light)))))
	 `(magit-diff-context-highlight ((t (:background ,(c 'selected 'very-light) :foreground ,(c 'selected)))))
	 ...
	 `(magit-diff-hunk-heading-highlight ((t (:background ,(c 'selected 'light) :foreground ,gray))))
	 `(magit-diff-added ((t (:background ,(c 'green 'light-grayish) :foreground ,(c 'green) :extend t))))
	 `(magit-diff-removed ((t (:background ,(c 'red 'light-grayish) :foreground ,(c 'red) :extend t))))
	 `(magit-diff-added-highlight ((t (:background ,(c 'green 'light) :foreground ,(c 'green) :extend t))))
	 `(magit-diff-removed-highlight ((t (:background ,(c 'red 'light) :foreground ,(c 'red) :extend t))))
	 `(magit-diffstat-added ((t (:foreground ,(c 'green)))))
	 `(magit-diffstat-removed ((t (:foreground ,(c 'red)))))
	 `(magit-diff-lines-heading ((t (:background ,(c 'orange) :foreground ,(c 'orange 'light)))))
	 '(magit-diff-whitespace-warning ((t (:inherit (trailing-whitespace)))))
	 `(trailing-whitespace ((t (:background ,(c 'red)))))
	 `(magit-branch-local ((t (:foreground ,(c 'blue)))))
	 '(magit-branch-current ((t (:box (:line-width 1 :color nil :style nil) :inherit (magit-branch-local)))))
	 ...
	 `(magit-hash ((t (:foreground ,(c 'magenta)))))
	 `(magit-log-author ((t (:foreground ,(c 'red)))))
	 `(magit-blame-highlight ((t (:background ,(c 'selected 'light) :foreground ,(c 'selected 'dark)))))
	 `(magit-tag ((t (:foreground ,(c 'orange)))))
	 `(magit-bisect-bad ((t (:foreground ,(c 'red)))))
	 `(magit-bisect-good ((t (:foreground ,(c 'green)))))
	 `(magit-bisect-skip ((t (:foreground ,(c 'blue)))))
	 ...
	 `(company-scrollbar-fg ((t (:background ,(c 'selected)))))
	 `(company-tooltip ((t (:background ,(c 'selected 'very-light) :foreground ,fg))))
	 `(company-tooltip-common ((t :foreground ,(c 'selected))))
	 '(company-tooltip-common-selection ((t (:inherit company-tooltip-common))))
	 `(company-tooltip-annotation ((t (:foreground ,(c 'selected)))))
	 `(company-tooltip-selection ((t (:background ,(c 'selected 'light) :foreground ,fg))))
	 `(lsp-ui-doc-background ((t (:background ,very-light-gray))))
	 `(avy-lead-face ((t (:background ,(c 'selected 'light) :foreground ,(c 'selected 'dark)))))
	 '(avy-lead-face-0 ((t (:inherit (avy-lead-face)))))
	 '(avy-lead-face-1 ((t (:inherit (avy-lead-face)))))
	 '(avy-lead-face-2 ((t (:inherit (avy-lead-face)))))
	 '(aw-leading-char-face ((t (:height 2.0 :inherit (avy-lead-face)))))
	 `(aw-background-face ((t (:foreground ,(c 'selected 'light-grayish)))))
	 `(sh-heredoc ((t (:foreground ,(c 'yellow)))))
	 `(error ((t (:foreground ,(c 'red) :weight bold))))
	 `(warning ((t (:foreground ,(c 'orange) :weight bold))))
	 `(success ((t (:foreground ,(c 'green) :weight bold))))
