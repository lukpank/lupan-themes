...
(defun lupan-themes-create-dark-theme (theme bg)
  (cl-labels ((base (hue) (lupan-themes-hsl-to-hex hue 0.25 0.7))
    ...
    (let ((black "#000000")
	  ...
	  (dark2-slate-blue (dark2 'SlateBlue2))
      ...
      (custom-theme-set-faces
       ...
       `(region ((t (:background ,(dark2 selected) :extend t))))
       `(shadow ((t (:foreground ,(dark2-grayish selected)))))
       `(highlight ((t (:background ,(dark1-grayish selected)))))
  ...
  (let ((base-luminance 0.5)
    ...
    (cl-labels ((base (hue) (lupan-themes-hsl-to-hex hue 0.3 base-luminance))
      ...
      (let ((black "#000000")
	    ...
	    (light-red (light 'red))
	    (light-yellow-gray (light-grayish 'yellow))
	    (light-blue-gray (light-grayish 'blue))
	...
	(custom-theme-set-faces
	 ...
	 `(mode-line ((t (:background ,(light selected) :foreground ,(base selected) :box (:line-width -1 :style released-button)))))
	 `(mode-line-inactive ((t (:background ,(light-grayish selected) :foreground ,(grayish selected) :box (:line-width -1 :style released-button) :inherit (mode-line)))))
	 `(minibuffer-prompt ((t (:foreground ,(base selected)))))
	 `(region ((t (:background ,(light selected) :extend t))))
	 `(shadow ((t (:foreground ,(light-grayish selected)))))
	 `(highlight ((t (:background ,(light selected)))))
	 ...
	 `(helm-match ((t (:foreground ,yellow))))
	 `(helm-separator ((t (:foreground ,red))))
	 `(helm-candidate-number ((t (:background ,(very-light selected) :foreground ,(base selected)))))
	 `(helm-source-header ((t (:weight bold :height 1.3 :family "Sans Serif"))))
	 ...
	 `(magit-hash ((t (:foreground ,magenta))))
	 `(magit-log-author ((t (:foreground ,red))))
	 `(magit-blame-highlight ((t (:background ,(light selected) :foreground ,(base selected)))))
	 `(magit-tag ((t (:foreground ,orange))))
	 `(magit-bisect-bad ((t (:foreground ,red))))
	 `(magit-bisect-good ((t (:foreground ,green))))
	 `(magit-bisect-skip ((t (:foreground ,blue))))
	 ...
	 `(avy-lead-face ((t (:background ,(light selected) :foreground ,(base selected)))))
	 '(avy-lead-face-0 ((t (:inherit (avy-lead-face)))))
	 '(avy-lead-face-1 ((t (:inherit (avy-lead-face)))))
	 '(avy-lead-face-2 ((t (:inherit (avy-lead-face)))))
	 '(aw-leading-char-face ((t (:height 2.0 :inherit (avy-lead-face)))))
