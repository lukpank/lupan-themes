...
(defun lupan-themes-create-dark-gray-theme (theme)
  (let* ((normal (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.25 0.7))))
	 (dark1 (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.14 0.5))))
	 (dark2 (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.25 0.4))))
	 (dark3 (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.25 0.3))))
	 (dark1-grayish (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.07 0.5))))
	 (dark3-grayish (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.07 0.3))))
	 (black "#000000")
...
(defun lupan-themes-create-dark-theme (theme)
  (let* ((normal (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.4 0.7))))
	 (dark1 (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.14 0.5))))
	 (dark2 (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.25 0.4))))
	 (dark3 (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.25 0.3))))
	 (dark1-grayish (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.07 0.5))))
...
(defun lupan-themes-create-light-theme (theme)
  (let* ((normal (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.3 0.5))))
	 (light (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.4 0.8))))
	 (greish (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.07 0.5))))
	 (dark1 (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.14 0.5))))
	 (dark3 (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.25 0.3))))
	 (dark1-grayish (lambda (hue) (apply #'color-rgb-to-hex (color-hsl-to-rgb hue 0.07 0.5))))
	 (black "#000000")
    ...
    (custom-theme-set-faces
     ...
     `(diff-refine-added ((t (:background ,light-green))))
