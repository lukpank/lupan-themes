...
(defun lupan-themes-create-theme (theme)
  (let* ((dark (eq theme 'lupan-dark))
	 (c (lambda (material-dark material-light &optional dark-blue dark light)
	      (cond
	       ((eq theme 'lupan-material-dark) material-dark)
	       ((eq theme 'lupan-material-light) material-light)
	       ((and dark-blue (eq theme 'lupan-dark-blue)) dark-blue)
	       ((and dark (eq theme 'lupan-dark)) dark)
	       ((and light (eq theme 'lupan-light)) light)
	       (t dark))))
	 (red-1-9 (funcall c "#ffcdd2" "#b71c1c" "#e694a9" "#e694a9" "#912e18"))
	 (red-2-6 (funcall c "#ef9a9a" "#e53935" "#ef6a6c" "#ef6a6c" "#cb390c"))
	 (red-4 (funcall c "#ef5350" "#ef5350" "#e6436d" "#e6436d" "#e6436d"))
	 (red-7-1 (funcall c "#d32f2f" "#ffcdd2" "#b11c23" "#b11c23" "#b11c23"))
	 (red-9-0 (funcall c "#b71c1c" "#ffebee" "#912e18" "#912e18" "#e6c2c1"))
	 (red-9-1 (funcall c "#b71c1c" "#ffcdd2" "#912e18" "#912e18" "#e8b2b8"))
	 (pink-2-6 (funcall c "#f48fb1" "#d81b60" "#d58faa" "#d58faa" "#d58faa"))
	 (purple-2-6 (funcall c "#ce93d8" "#8e24aa" "#dc88e9" "#dc88e9" "#dc88e9"))
	 (purple-4 (funcall c "#ab47bc" "#ab47bc" "#a423ab" "#a423ab" "#a423ab"))
	 (indigo-2-6 (funcall c "#9fa8da" "#3949ab" "#8e9ed2" "#8e9ed2" "#6668b8"))
	 (indigo-8-1 (funcall c "#283593" "#c5cae9" "#1e158d" "#1e158d" "#b0ccde"))
	 (blue-2-6 (funcall c "#90caf9" "#1e88e5" "#25bcf6" "#25bcf6" "#3585ce"))
	 (blue-6-2 (funcall c "#1e88e5" "#90caf9" "#0f76fa" "#0f76fa" "#9dddf1"))
	 (cyan-2-6 (funcall c "#80deea" "#00acc1" "#62dafb" "#62dafb" "#29a6da"))
	 (teal-2-6 (funcall c "#80cbc4" "#00897b" "#77adc4" "#77adc4" "#23aba4"))
	 (teal-6-1 (funcall c "#00897b" "#b2dfdb" "#037785" "#037785" "#c1e6c2"))
	 (green-1-9 (funcall c "#c8e6c9" "#1b5e20" "#94e6a9" "#94e6a9" "#078035"))
	 (green-2-6 (funcall c "#a5d6a7" "#43a047" "#59c19f" "#59c19f" "#1ebf33"))
	 (green-7-1 (funcall c "#388e3c" "#c8e6c9" "#078035" "#078035" "#94e6a9"))
	 (green-9-0 (funcall c "#1b5e20" "#e8f5e9" "#30503d" "#30503d" "#c1e6c2"))
	 (green-9-1 (funcall c "#1b5e20" "#c8e6c9" "#30503d" "#30503d" "#94e6a9"))
	 (light-green-2-6 (funcall c "#c5e1a5" "#7cb342" "#b4e4ba" "#b4e4ba" "#57e594"))
	 (lime-2-7 (funcall c "#e6ee9c" "#afb42b" "#e8ee8e" "#e8ee8e" "#d6a708"))
	 (lime-4 (funcall c "#d4e157" "#d4e157" "#dce988" "#dce988" "#dce988"))
	 (lime-7-2 (funcall c "#afb42b" "#e6ee9c" "#8fa840" "#8fa840" "#8fa840"))
	 (yellow-2-6 (funcall c "#fff59d" "#fdd835" "#e9dc88" "#e9dc88" "#e9dc88"))
	 ...
	 (orange-4-6 (funcall c "#ffa726" "#fb8c00" "#ff8110" "#ff8110" "#ff8110"))
	 (orange-2-8 (funcall c "#ffcc80" "#ef6c00" "#fdb22d" "#fdb22d" "#fdb22d"))
	 (deep-orange-2-6 (funcall c "#ffab91" "#f4511e" "#e59457" "#e59457" "#e59457"))
	 (brown-2 (funcall c "#bcaaa4" "#bcaaa4" "#d5aa8f" "#d5aa8f" "#d5aa8f"))
	 (brown-2-3 (funcall c "#bcaaa4" "#a1887f" "#d5aa8f" "#d5aa8f" "#d5aa8f"))
	 (brown-2-6 (funcall c "#bcaaa4" "#6d4c41" "#d5aa8f" "#d5aa8f" "#d5aa8f"))
	 (brown-4 (funcall c "#8d6e63" "#8d6e63" "#8a6c3b" "#8a6c3b" "#8a6c3b"))
	 (grey-0 "#fafafa")
	 (grey-2-6 (funcall c "#eeeeee" "#757575"))
	 (grey-4-6 (funcall c "#bdbdbd" "#757575"))
	 (grey-5 "#9e9e9e")
	 (grey-6-4 (funcall c "#757575" "#bdbdbd" "#575757" "#575757" "#c0c0c0"))
	 (grey-7-1 (funcall c "#616161" "#f5f5f5" "#505050" "#505050" "#d0d0d0"))
	 (grey-8-1 (funcall c "#424242" "#f5f5f5"))
	 (grey-9 "#212121")
	 (grey-9-2 (funcall c "#212121" "#eeeeee"))
	 (blue-grey-2-4 (funcall c "#b0bec5" "#78909c" "#96c4c9" "#96c4c9" "#9ad1cc"))
	 (blue-grey-2-6 (funcall c "#b0bec5" "#546e7a" "#96c4c9" "#96c4c9" "#2081a0"))
	 (blue-grey-6-0 (funcall c "#546e7a" "#eceff1" "#3b6c8a" "#3b6c8a" "#a5c9cb"))
	 (blue-grey-6-2 (funcall c "#546e7a" "#b0bec5" "#3b6c8a" "#3b6c8a" "#d1d6b2"))
	 (blue-grey-7-1 (funcall c "#455a64" "#cfd8dc" "#225776" "#225776" "#e1e6c2"))
	 (default-bg (funcall c "#424242" "#fafafa" "#092e50" "#1a3a34" "#f2f6e1"))
	 (default-fg (funcall c "#eeeeee" "#424242" "#c0c0c0" "#f2f6e1" "#1a3a34"))
	 (bg-1 (funcall c "#4e4e4e" "#e2e2e2" "#0b365a" "#1c443e" "#e8f3d9"))
	 (bg-2 (funcall c "#5b5b5b" "#d5d5d5" "#0d3e63" "#1e4e4a" "#ddefd1"))
	 (bg-3 (funcall c "#676767" "#c9c9c9" "#0f476c" "#1f5956" "#d0ebca"))
	 (bg-4 (funcall c "#737373" "#bdbdbd" "#125075" "#206364" "#c3e6c4"))
	 (bg-5 (funcall c "#7f7f7f" "#b1b1b1" "#14597e" "#216b6f" "#bce2c5"))
	 (bg-6 (funcall c "#8c8c8c" "#a4a4a4" "#176387" "#21727b" "#b6dcc7"))
	 )
