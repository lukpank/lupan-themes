...
(defun lupan-themes-create-light-theme (theme)
  (let* ((hsl-to-hex (lambda (h s l) (apply #'color-rgb-to-hex (append (color-hsl-to-rgb h s l) '(2)))))
	 ...
	 (light-l 0.8)
	 (very-light-l 0.9)
	 (normal (lambda (hue) (funcall hsl-to-hex hue 0.3 normal-l)))
	 (grayish (lambda (hue) (funcall hsl-to-hex hue 0.15 normal-l)))
	 (light (lambda (hue) (funcall hsl-to-hex hue 0.4 light-l)))
	 (light-grayish (lambda (hue) (funcall hsl-to-hex hue 0.15 light-l)))
	 (very-light (lambda (hue) (funcall hsl-to-hex hue 0.4 very-light-l)))
	 (black "#000000")
	 (bg "#f2f6e1")
	 (fg "#1a3a34")
	 (very-light-gray (funcall hsl-to-hex 0.5 0.0 very-light-l))
	 (light-gray (funcall hsl-to-hex 0.5 0.0 light-l))
	 (gray (funcall hsl-to-hex 0.5 0.0 normal-l))
	 (very-light-yellow (funcall very-light 0.17))
	 (light-yellow (funcall light 0.17))
	 (light-orange (funcall light 0.1))
	 (light-green (funcall light 0.33))
	 (light-blue (funcall light 0.58))
	 (light-magenta (funcall light 0.83))
	 (light-red (funcall light 1.0))
	 (light-yellow-gray (funcall light-grayish 0.17))
	 (light-blue-gray (funcall light-grayish 0.58))
	 (green-gray (funcall grayish 0.33))
	 (cyan-gray (funcall grayish 0.5))
	 (red-gray (funcall grayish 1.0))
	 (orange (funcall normal 0.1))
	 (yellow (funcall normal 0.17))
	 (lime (funcall normal 0.24))
	 (green (funcall normal 0.33))
	 ...
	 (magenta (funcall normal 0.83))
	 (red (funcall normal 1.0))
	 (blue-gray (funcall grayish 0.58)))
    (custom-theme-set-faces
     theme
     `(default ((t (:background ,bg :foreground ,fg))))
     `(fringe ((t (:background ,bg))))
     ...
     `(mode-line-inactive ((t (:background ,light-blue-gray :foreground ,fg :box (:line-width -1 :style released-button) :inherit (mode-line)))))
     `(minibuffer-prompt ((t (:foreground ,blue))))
     `(region ((t (:background ,light-yellow :extend t))))
     `(shadow ((t (:foreground ,cyan-gray))))
     ...
     `(helm-match ((t (:foreground ,yellow))))
     `(helm-separator ((t (:foreground ,red))))
     `(helm-candidate-number ((t (:background ,light-yellow-gray :foreground ,fg))))
     `(helm-source-header ((t (:weight bold :height 1.3 :family "Sans Serif"))))
     ...
     `(magit-diff-hunk-heading-highlight ((t (:background ,light-yellow :foreground ,gray))))
     ...
     `(company-scrollbar-fg ((t (:background ,light-orange))))
     ...
     '(avy-lead-face-2 ((t (:inherit (avy-lead-face)))))
     '(aw-leading-char-face ((t (:height 2.0 :inherit (avy-lead-face)))))
     `(aw-background-face ((t (:foreground ,blue-gray))))
     `(sh-heredoc ((t (:foreground ,yellow))))
     `(error ((t (:foreground ,red :weight bold))))
     `(warning ((t (:foreground ,orange :weight bold))))
     `(success ((t (:foreground ,green :weight bold))))
